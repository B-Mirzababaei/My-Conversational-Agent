...
public class LightSideMessageAnnotator2 extends BasilicaAdapter
{
...
//	String host = "http://kcs-rebo4ai-internal.know.know-center.at";
	...
	public LightSideMessageAnnotator2(Agent a)
	{
		super(a);
...
//		classify_dict.put("notdetected",Double.parseDouble("60"));
	...
	public void preProcessEvent(InputCoordinator source, Event event)
	{
		...
		if (label != null && !label.equals(""))
		{
			...
			me.addAnnotations("WARRANT_WITHOUT");
		}
...
//		rettext = rettext.replace("\t", " ");
	...
	public String annotateText(String text)
	{
		...
		try {
			System.err.println("=== LightSideMessageAnnotator2 - classification " + text + " =================================");
...
//	    	return "DETECTED" 
	...
	public String parseLightSideResponse(StringBuilder response)
	{
		...
		for (int i=0; i < listLength; i++) {
			...
			log(Logger.LOG_NORMAL, "=== LightSideMessageAnnotator2 - classification " + classification + " " + Double.toString(classificationPercent) + "%");

			try {
				classificationThreshold = classify_dict.get(classification);
				log(Logger.LOG_NORMAL, "=== LightSideMessageAnnotator2 - classificationThreshold " + classificationThreshold + "   000000000000000000000000000000%");
	...
	public static void main(String[] args)
	{
		...
		LightSideMessageAnnotator2 annotator = new LightSideMessageAnnotator2(null);
